...
export const verifyEmail = state.verifyEmail; // ();

export const resetPassword = state.resetPassword; // (userEmail);
...
export const changeDisplayName = state.changeDisplayName; // (userId, newName)

export const changeEmail = state.changeEmail // (userId, newEmail)